...
export interface RelaxResultResult {
    ...
    fits?: models.RelaxResultResultAllOfFits;

    test_results?: models.RelaxResultResultAllOfTestResults;

}
export namespace RelaxResultResult {
