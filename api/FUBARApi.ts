...
export class FUBARApi {
     ...
     */
    public getFUBARJob(fubarRequest: models.FubarRequest, prettyPrint?: boolean, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.FubarResult;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/methods/fubar-result';

        let queryParameters: any = {};
        let headerParams: any = {};
        // verify required parameter 'fubarRequest' is not null or undefined
        if (fubarRequest === null || fubarRequest === undefined) {
            throw new Error('Required parameter fubarRequest was null or undefined when calling getFUBARJob.');
        }
        ...
        requestOptions.data = JSON.stringify(fubarRequest);
        ...
        $.ajax(requestOptions).then(
            (data: models.FubarResult, textStatus: string, jqXHR: JQueryXHR) =>
     ...
     * @param prettyPrint Pretty print response
     */
    public startFUBARJob(fubarRequest: models.FubarRequest, prettyPrint?: boolean, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.JobStatus;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/methods/fubar-start';

        let queryParameters: any = {};
        let headerParams: any = {};
        // verify required parameter 'fubarRequest' is not null or undefined
        if (fubarRequest === null || fubarRequest === undefined) {
            throw new Error('Required parameter fubarRequest was null or undefined when calling startFUBARJob.');
        }
